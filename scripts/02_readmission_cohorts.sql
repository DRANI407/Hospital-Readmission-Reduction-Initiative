-- Step 2a: Readmission cohort analysis — Hospital Readmission Reduction Initiative
-- Builds encounters_clean, readmission_flags, and readmission_analytics (30-day readmit flag, age_midpoint, labels).
-- Run after 01_load_data.py (requires encounters, admission_types, discharge_dispositions, admission_sources).

-- Step 1: Create clean encounters with simulated dates
...
-- Step 2: Define 30-day readmission flag per encounter
...
-- Step 3: Create analytics table with features and mapping labels
