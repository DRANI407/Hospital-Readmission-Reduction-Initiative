...
Outputs: readmission_project/outputs/financial_analysis_dashboard.png,
...
plt.tight_layout()
plt.savefig(OUTPUTS_DIR / 'financial_analysis_dashboard.png', dpi=150, bbox_inches='tight')
plt.close()

print(f"Saved dashboard to {OUTPUTS_DIR / 'financial_analysis_dashboard.png'}")
